...
class XSS_Clean
{
     ...
     *  version 1.7.1.
     *
     *  <i>This method is automatically run for each control when calling {@link Iriven_FormManager::validate() validate()}, unless
     *  specifically disabled by {@link Iriven_FormManager_Control::disable_xss_filters() disable_xss_filters()})!</i>
     *
