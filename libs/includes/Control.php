 ...
 *  @package    Generic
 */
class Iriven_FormManager_Control extends XSS_Clean
{
     ...
     *  @access private
     */
    function Iriven_FormManager_Control()
    {
     ...
     *
     *  <i>This method is automatically called by the form's {@link Iriven_FormManager::validate() validate()} method!</i>
     *
     *  <code>
     *  //  $obj is a reference to a control
            ...
            if (isset($this->submitted_value)) {
                ...
                switch ($attribute['type']) {
                    ...
                    case 'select':
                        ...
                        // Iriven_FormManager_Select::_render_attributes() method
     ...
     *
     *                                      For example, the {@link Iriven_FormManager_Text text} control has, by default, the
     ...
     *  See the {@link Iriven_FormManager::$show_all_error_messages show_all_error_messages} property.
     *
     *  <b>Everything related to error blocks applies only for server-side validation.</b><br>
     *  <b>See the {@link Iriven_FormManager::client_side_validation() client_side_validation()} method for configuring how errors
     ...
     *
     *  Available for the following controls: {@link Iriven_FormManager_Password password}, {@link Iriven_FormManager_Text text},
     *  {@link Iriven_FormManager_Textarea textarea}
     *
     *  <code>
     *  /* $obj is a reference to a control {@*}
     *  $obj->set_rule(
     ...
     *
     *
     *  Validates if the value matches the characters seen in the {@link Iriven_FormManager_Captcha captcha} image
     *  (therefore, there must be a {@link Iriven_FormManager_Captcha captcha} image on the form)
     *
     *  Available only for the {@link Iriven_FormManager_Text text} control
     *
     ...
     *  -   <i>error_message</i> is the error message to be shown when rule is not obeyed
     *
     *  <b>This rule requires the prior inclusion of the {@link http://stefangabos.ro/php-libraries/zebra-image Iriven_Image}
     *  library!</b>
     *
     ...
     *
     *  Available only for the {@link Iriven_FormManager_File file} control
     *
     *  <i>This rule is not available client-side!</i>
     *
     *  <code>
     ...
     *  </code>
     *
     *  <b>If {@link Iriven_FormManager::client_side_validation() client-side validation} is enabled (enabled by default), the
     ...
     *  {@link Iriven_FormManager_Date::format() format()} method.
     *
     *  Available only for the {@link Iriven_FormManager_Date date} control.
     *
     ...
     *
     *  Available for the following controls: {@link Iriven_FormManager_Checkbox checkbox}, {@link Iriven_FormManager_Date date},
     *  {@link Iriven_FormManager_File file}, {@link Iriven_FormManager_Password password}, {@link Iriven_FormManager_Radio radio},
     *  {@link Iriven_FormManager_Select select}, {@link Iriven_FormManager_Text text}, {@link Iriven_FormManager_Textarea textarea}
     *
     *  <code>
     *  /* $obj is a reference to a control {@*}
     *  $obj->set_rule(
     ...
     *
     *      Set this to FALSE (or, for better code readability, you should use the "IRIVEN_FORMMANAGER_UPLOAD_RANDOM_NAMES"
     ...
     *
     *  <i>Remember to check the form's {@link Iriven_FormManager::$file_upload $file_upload} property for information about the
     ...
     *          IRIVEN_FORMMANAGER_UPLOAD_RANDOM_NAMES,     /* upload file with random-generated name {@*}
     *          'error',                            /* variable to add the error message to {@*}
     *          'File could not be uploaded!'       /* error message if value doesn't validate {@*}
     *       )
     *  );
            ...
            foreach ($rules as $rule_name => $rule_properties) {
                ...
                switch ($rule_name) {
                    ...
                    case 'float':
                        ...
                        $this->set_attributes(array('onkeypress' => 'javascript:return $(\'#' . preg_replace('/\-/', '_', $this->form_properties['name']) . '\').data(\'Iriven_FormManager\').filter_input(\'' . $rule_name . '\', event' . ($rule_properties[0] != '' ? ', \'' . addcslashes($rule_properties[0], '\'') . '\'' : '') . ');'));
