 ...
 *  @package    Controls
 */
class Iriven_FormManager_Date extends Iriven_FormManager_Control
{
     ...
     *
     *  The output of this control will be a {@link Iriven_FormManager_Text textbox} control with an icon to the right of it.<br>
     ...
     *  @return void
     */
    function Iriven_FormManager_Date($id, $default = '', $attributes = '')
    {
