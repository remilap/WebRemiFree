 ...
 *  @package    Controls
 */
class Iriven_FormManager_Label extends Iriven_FormManager_Control
{
     ...
     *
     *                                  Just like in the case of {@link Iriven_FormManager_Note notes}, if you want a <b>master</b>
     ...
     *                                  is a {@link Iriven_FormManager_Text textbox} or a {@link Iriven_FormManager_Textarea textarea}) and
     ...
     *  @return void
     */
    function Iriven_FormManager_Label($id, $attach_to, $caption, $attributes = '')
    {
