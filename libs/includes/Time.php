 ...
 *  @package    Controls
 */
class Iriven_FormManager_Time extends Iriven_FormManager_Control
{
     ...
     *
     *  The output of this control will be one, two or three {@link Iriven_FormManager_Select select} controls for hour, minutes
     ...
     *  @return void
     */
    function Iriven_FormManager_Time($id, $default = '', $attributes = '')
    {
