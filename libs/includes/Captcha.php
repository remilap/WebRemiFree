...
class Iriven_FormManager_Captcha extends Iriven_FormManager_Control
{
     ...
     *
     *  <b>You must also place a {@link Iriven_FormManager_Text textbox} control on the form and set the "captcha" rule to it!
     ...
     *                                  </code>
     *
     *  @param  string  $attach_to      The <b>id</b> attribute of the {@link Iriven_FormManager_Text textbox} control to attach
     *                                  the CAPTCHA image to.
     *
     *  @return void
     */
    function Iriven_FormManager_Captcha($id, $attach_to)
    {
