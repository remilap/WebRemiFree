 ...
 *  @package    Controls
 */
class Iriven_FormManager_Select extends Iriven_FormManager_Control
{
     ...
     *  "<i>-&nbsp;select&nbsp;-</i>" taken from the language file - see the {@link Iriven_FormManager::language() language()}
     ...
     *                                  {@link Iriven_FormManager_Text textbox} control will be automatically created having the
     ...
     *  @return void
     */
    function Iriven_FormManager_Select($id, $default = '', $attributes = '', $default_other = '')
    {
