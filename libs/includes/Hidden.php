 ...
 *  @package    Controls
 */
class Iriven_FormManager_Hidden extends Iriven_FormManager_Control
{
     ...
     *
     *                                  <b>Hidden controls are automatically rendered when the {@link Iriven_FormManager::render() render()}
     ...
     *  @return void
     */
    function Iriven_FormManager_Hidden($id, $default = '')
    {
