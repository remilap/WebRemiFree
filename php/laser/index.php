...
?>
<A HREF="couleur_list.php"><BUTTON NAME='listCouleur' VALUE='Display couleur list' onClick='couleur_list.php'>Display couleur list</BUTTON></A>
<A HREF="taille_list.php"><BUTTON NAME='listTaille' VALUE='Display taille list' onClick='taille_list.php'>Display taille list</BUTTON></A>
<A HREF="place_logo_list.php"><BUTTON NAME='listPlaceLogo' VALUE='Display place logo list' onClick='place_logo_list.php'>Display place logo list</BUTTON></A>
